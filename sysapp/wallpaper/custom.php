...
<div class="wapppaperwebsite form-inline">
	...
	<div class="input-append">
		<input type="text" id="wallpaperurl" style="width:350px" placeholder="请输入一个URL地址（地址以 jpg, jpeg, png, gif, html, htm 结尾）" value="<?=$wallpaper['wallpaperwebsite']?>"><button type="button" class="btn">应用</button>
	</div>
</div>
